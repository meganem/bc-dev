...
/**
 * Template for Bloomcase Project nodes.
 *
 * @file
...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <p><a href="<?php print $jsonPath; ?>">json data for this project</a></p>
  <p><a href="<?php print $jsonPath; ?>/evolvedTo">evolvedTo data for this project</a></p>
  	<svg id="timeline">
	...
	<script>
        // get the json
        var jsonPath = "<?php print $jsonPath; ?>";
        var jsonEvolvedTo = "<?php print $jsonPath; ?>/evolvedTo";
